...
def _init_wandb_common():
    ...
    wandb.define_metric("eval_progress/step")
    wandb.define_metric("eval_progress/*", step_metric="eval_progress/step")
    wandb.define_metric("hw/eval_stream/*", step_metric="eval_progress/step")
